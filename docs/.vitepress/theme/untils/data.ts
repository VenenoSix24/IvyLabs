...
export const NAV_DATA: NavData[] = [
  {
    ...
    items: [
      ...
      {
        icon: 'https://favicon.im/www.json.cn',
        title: 'Json 中文网',
        badge: {
          text: '请给茂茂点点小星星哦',
          type: 'info',
  ...
  },
  {
    ...
    items: [
      {
        icon: 'https://favicon.im/chat.openai.com?larger=true',
        title: 'ChatGPT（最强）',
      ...
      {
        icon: 'https://favicon.im/www.beautiful.ai?larger=true',
  ...
  },
  {
    ...
    items: [
      ...
      {
        icon: 'https://favicon.im/nextjs.org?larger=true',
        title: 'Next.js',
  ...
  },
  {
    ...
    items: [
      ...
      {
        icon: 'https://favicon.im/docs.taro.zone?larger=true',
        title: 'Taro',
        desc: '多端统一开发解决方案',
  ...
  },
  {
    ...
    items: [
      {
        icon: 'https://favicon.im/nodejs.org',
        title: 'Node.js',
        desc: 'Node.js 是一个基于 Chrome V8 引擎的 JavaScript 运行环境',
        link: 'https://nodejs.org/zh-cn'
      },
      {
        icon: 'https://favicon.im/expressjs.com?larger=true',
        title: 'Express',
  ...
  },
  {
    ...
    items: [
      ...
      {
        icon: 'https://favicon.im/www.runoob.com?larger=true',
        title: '菜鸟教程',
        desc: '学的不仅是技术，更是梦想！',
        link: 'https://www.runoob.com'
      },
      {
        icon: 'https://favicon.im/es6.ruanyifeng.com?larger=true',
        title: 'ES6 入门教程',
        desc: '阮一峰的网络日志',
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: '博客园',
        icon: 'https://favicon.im/common.cnblogs.com',
  ...
  },
  {
    ...
    items: [
      ...
      {
        icon: 'https://favicon.im/www.youtube.com?larger=true',
        title: 'YouTube',
        // desc: '',
        link: 'https://www.youtube.com'
      },
      {
        icon: 'https://favicon.im/twitter.com?larger=true',
        title: 'Twitter',
        // desc: '',
